...
const products: ProductInput[] = [
  {
    productId: 10,
    name: 'A',
    amounts: [{ ingredientId: 1, amount: 400, unit: 'IU' }],
  }, // 10㎍
  {
    productId: 11,
    name: 'B',
  ...
  const unknownProducts: ProductInput[] = [
    {
      productId: 30,
      name: 'X',
      amounts: [{ ingredientId: 99, amount: 10, unit: 'mg' }],
    },
  ];
  const out = runAnalysis({
    ageMonths: 96,
  ...
  const twoProducts: ProductInput[] = [
    {
      productId: 40,
      name: 'D-only',
      amounts: [{ ingredientId: 1, amount: 800, unit: 'IU' }],
    }, // 20㎍, single product within UL → SAFE
    {
      productId: 41,
      name: 'C-only',
      amounts: [{ ingredientId: 2, amount: 600, unit: 'mg' }],
    }, // 600mg > UL 500 → OVER
  ];
  const out = runAnalysis({
    ageMonths: 96,
